...
public class DefectDialogue {
    public static String getCardDialogue(String cardID) {
        if ("Ball Lightning".equals(cardID)) {
        ...
        if ("Conserve Battery".equals(cardID)) {
        ...
        if ("Compile Driver".equals(cardID)) {
        ...
        if ("Go for the Eyes".equals(cardID)) {
        ...
        if ("Doom and Gloom".equals(cardID)) {
        ...
        if ("Double Energy".equals(cardID)) {
        ...
        if ("Genetic Algorithm".equals(cardID)) {
        ...
        if ("Reinforced Body".equals(cardID)) {
        ...
        if ("Static Discharge".equals(cardID)) {
        ...
        if ("Biased Cognition".equals(cardID)) {
        ...
        if ("Electrodynamics".equals(cardID)) {
        ...
        if ("Meteor Strike".equals(cardID)) {
        ...
        if ("Thunder Strike".equals(cardID)) {
    ...
    public static String getPotionDialogue(String potionID) {
        if ("EssenceOfDarkness".equals(potionID)) {
        ...
        if ("FocusPotion".equals(potionID)) {
        ...
        if ("PotionOfCapacity".equals(potionID)) {

...
public class IroncladDialogue {
    public static String getCardDialogue(String cardID) {
      ...
      if ("Clothesline".equals(cardID)) {
        ...
        if ("Perfected Strike".equals(cardID)) {
        ...
        if ("Pommel Strike".equals(cardID)) {
        ...
        if ("Sword Boomerang".equals(cardID)) {
        ...
        if ("Battle Trance".equals(cardID)) {
        ...
        if ("Blood for Blood".equals(cardID)) {
        ...
        if ("Fire Breathing".equals(cardID)) {
        ...
        if ("Flame Barrier".equals(cardID)) {
        ...
        if ("Ghostly Armor".equals(cardID)) {
        ...
        if ("Infernal Blade".equals(cardID)) {
        ...
        if ("Power Through".equals(cardID)) {
        ...
        if ("Reckless Charge".equals(cardID)) {
        ...
        if ("Spot Weakness".equals(cardID)) {
    ...
    public static String getPotionDialogue(String potionID) {
        if ("ElixirPotion".equals(potionID)) {
        ...
        if ("BloodPotion".equals(potionID)) {
        ...
        if ("HeartOfIron".equals(potionID)) {

...
public class ColorlessDialogue {
    public static String getCardDialogue(String cardID) {
        ...
        if ("Dark Shackles".equals(cardID)) {
        ...
        if ("Dramatic Entrance".equals(cardID)) {
        ...
        if ("Enlightenment".equals(cardID)) {
        ...
        if ("Flash of Steel".equals(cardID)) {
        ...
        if ("Good Instincts".equals(cardID)) {
        ...
        if ("Jack Of All Trades".equals(cardID)) {
        ...
        if ("Master of Strategy".equals(cardID)) {
        ...
        if ("Metamorphosis".equals(cardID)) {
        ...
        if ("Sadistic Nature".equals(cardID)) {
        ...
        if ("Secret Technique".equals(cardID)) {
        ...
        if ("Secret Weapon".equals(cardID)) {
        ...
        if ("Thinking Ahead".equals(cardID)) {
        ...
        if ("Transmutation".equals(cardID)) {
    ...
    public static String getPotionDialogue(String potionID) {
        if ("Ancient Potion".equals(potionID)) {
            return "\"Exquisite! Was feeling parched.\" NL #b~Glup~ #b~glup~ #b~glup~ NL NL He downs the potion in one go and lets out a @burp.@ NL \"Ah, an Ancient Potion! Bitter taste, but you won't find a more effective prophylactic in the Spire.\" NL NL He rummages around his various pockets... NL \"Here, look what I've got for you today! Take it take it!\"";
        }
        if ("AttackPotion".equals(potionID)) {
            return "\"Exquisite! Was feeling parched.\" NL #b~Glup~ #b~glup~ #b~glup~ NL NL He downs the potion in one go and lets out an aggressive @burp.@ NL \"Disgusting! Tastes like a withered #rstrawberry, though I am no longer thirsty.\" NL NL He rummages around his various pockets... NL \"Here, look what I've got for you today! Take it take it, and excuse me while I satisfy the sudden urge to punch something.\"";
        }
        if ("BlessingOfTheForge".equals(potionID)) {
            return "\"Exquisite! Was feeling parched.\" NL #b~Glup~ #b~glup~ #b~glup~ NL NL He downs the potion in one go and lets out a @burp,@ which sounds oddly similar to the clanging of an anvil. NL \"The shape of this flask! Did you happen to snag this from that #p~creepy~ forge?\" NL NL He rummages around his various pockets... NL \"Here, look what I've got for you today! Take it take it!\"";
        }
        if ("Block Potion".equals(potionID)) {
            return "\"Exquisite! Was feeling parched.\" NL #b~Glup~ #b~glup~ #b~glup~ NL NL He downs the potion in one go and lets out a reserved @burp.@ NL \"My #yanxiety is gone! Consuming ~unknown~ substances once again proves to be a worthwhile endeavor.\" NL NL He calmly sorts through his various pockets... NL \"Here, look what I've got for you today! Take it take it!\"";
        }
        if ("ColorlessPotion".equals(potionID)) {
        ...
        if ("CultistPotion".equals(potionID)) {
        ...
        if ("Dexterity Potion".equals(potionID)) {
        ...
        if ("DistilledChaos".equals(potionID)) {
        ...
        if ("DuplicationPotion".equals(potionID)) {
        ...
        if ("Energy Potion".equals(potionID)) {
        ...
        if ("EntropicBrew".equals(potionID)) {
        ...
        if ("EssenceOfSteel".equals(potionID)) {
        ...
        if ("Explosive Potion".equals(potionID)) {
        ...
        if ("FairyPotion".equals(potionID)) {
        ...
        if ("Fire Potion".equals(potionID)) {
        ...
        if ("SteroidPotion".equals(potionID)) {
        ...
        if ("Fruit Juice".equals(potionID)) {
        ...
        if ("GamblersBrew".equals(potionID)) {
        ...
        if ("LiquidBronze".equals(potionID)) {
        ...
        if ("LiquidMemories".equals(potionID)) {
        ...
        if ("PowerPotion".equals(potionID)) {
        ...
        if ("Regen Potion".equals(potionID)) {
        ...
        if ("SkillPotion".equals(potionID)) {
        ...
        if ("SpeedPotion".equals(potionID)) {
        ...
        if ("Strength Potion".equals(potionID)) {
        ...
        if ("Swift Potion".equals(potionID)) {
        ...
        if ("Weak Potion".equals(potionID)) {
